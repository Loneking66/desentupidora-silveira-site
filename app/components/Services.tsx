...
const services = [
    {
        ...
        description:
            "Restauramos o fluxo da sua pia com rapidez e eficiência."

    },
    {
        title: "Desentupimento de Ralos",
        description:
            "Eliminamos obstruções em ralos residenciais e comerciais."
    },
    {
        title: "Desentupimentos de Vasos Sanitários",
        description: 
            "Solução rápida e eficaz para vasos sanitários entupidos."
    },
]
